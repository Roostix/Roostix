...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="bg-slate-950 w-full z-20 top-0 start-0  ">
            ...
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-default rounded-base bg-neutral-secondary-soft md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-neutral-primary">
              ...
              <li>
                <div className="flex space-x-2 pl-5  p-1 border-l border-gray-600">
                  <Button 
                    variant={language === 'en' ? "outlineModifiLanguage" : "outline"} 
                    size="sm"
                  ...
                  <Button 
                    variant={language === 'es' ? "outlineModifiLanguage" : "outline"} 
                    size="sm"
